...
function buildSignalR ($, window) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['ricebirdHub'] = this.createHubProxy('ricebirdHub');
        proxies['ricebirdHub'].client = {};
        proxies['ricebirdHub'].server = {
...
buildSignalR($, window);
var mixin = require("./mixin").default;
var recieve = mixin.methods.broadcast;

var hub = $.connection.ricebirdHub;
let signalR = {};
signalR = {
    connectionId: "",
    isConnected: false,
...
function connector (resolve, reject) {
    ...
    hub.client.connected = function (connId) {
        signalR.connectionId = connId;
        signalR.isConnected = true;
        if (promise) {
            resolve(connId);
        }
        recieve && recieve.apply(mixin.app, [null, "connected", [connId]]);
    }
...
let promise = new Promise(connector).then();
signalR.ready = function (callback) {
