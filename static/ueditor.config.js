...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL: "/Cores/Ricebird.UEditor/Scripts/"
        ...
        , toolbars: [[
            'fullscreen', 'source', 'template', '|', 'undo', 'redo', '|',
            ...
            'insertimage', /*'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'gmap', 'insertframe', 'insertcode', 'webapp', */
            'pagebreak', '|',
            'horizontal', 'date', 'time', 'spechars', 'wordimage', '|',
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|',
            'searchreplace', 'drafts'//, 'kityformula'
        ]]
